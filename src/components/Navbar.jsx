      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            <button
              onClick={() => scrollToSection("brand-kits")}
            ...
            <button
              ...
              className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-800 dark:text-white"
            >
              {darkMode ? (
        ...
        <div
          ...
          } pt-4 pb-6 absolute left-0 right-0 bg-white dark:bg-gray-900 border-t dark:border-gray-800 shadow-lg`}
          style={{ top: "100%" }}
        >
          <div className="flex flex-col space-y-4 px-6">
            ...
            <button
              onClick={toggleDarkMode}
              className="flex items-center py-2 hover:text-green-500"
            >
              {darkMode ? (
                <>
